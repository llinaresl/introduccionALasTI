			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Form </span> - Editar Tutorías</h4>
			...
			<div class="content">				
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="col-md-6">
							<fieldset>
								<legend class="font-weight-semibold"><i class="icon-reading mr-2"></i> Encontrar alumno</legend>
								
								<div class="form-group row">
									<label class="col-lg-3 col-form-label">Ingresa ID de tutoría a buscar</label>
									<div class="col-lg-9">
										<div class="row">
											<div class="col-md-6">
								...
								<div class="text-right">
									<button type="submit" class="btn btn-primary">Buscar tutoría <i class="icon-folder-search ml-2"></i></button>
								</div>
						...
						<form action="#">
							...
							<div class="text-right">
								<button type="submit" class="btn btn-primary">Editar tutoría <i class="icon-bookmark ml-2"></i></button>
							</div>
						</form>
					</div>
				</div>
