...
<head>
	...
	<title>Limitless - Responsive Web Application by Isaac Becerra</title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Base de datos</span> - Grupos</h4>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title"><b>GRUPOS</b></h5>
					...
					<div class="card-body">
						...
						<div class="table-responsive">
								<button type="submit" class="btn btn-outline-danger"  data-toggle="modal" data-target="#modal_form_horizontal">Agregar grupo <i class="icon-file-plus ml-2"></i></button>
						</div>
					</div>
								...
								<div class="card-body">
									<form action="#">
											...
											<div class="col-md-6">
												<fieldset>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9">
															<select data-placeholder="¿Dónde se encuentra?" class="form-control form-control-select2">
																<option>
										...
										<div class="text-right">
											<button type="submit" class="btn btn-primary">Editar grupo <i class="icon-users2 ml-2"></i></button>
										</div>
									</form>
								</div>
							</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<form action="#">
										...
										<div class="text-right">
											<button type="submit" class="btn btn-primary">Agregar grupo <i class="icon-users4 ml-2"></i></button>
										</div>
									</form>
								</div>
							</div>
