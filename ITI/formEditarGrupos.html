			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Form </span> - Editar Grupos</h4>
			...
			<div class="content">				
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="col-md-6">
							<fieldset>
								<legend class="font-weight-semibold"><i class="icon-reading mr-2"></i> Encontrar grupo</legend>
								
								<div class="form-group row">
									<label class="col-lg-3 col-form-label">Ingresa clave del grupo</label>
									<div class="col-lg-9">
										<div class="row">
											<div class="col-md-6">
												<input type="text" placeholder="Grupo" class="form-control">
											</div>

											<div class="text-right">
												<button type="submit" class="btn btn-primary">Buscar grupo <i class="icon-paperplane ml-2"></i></button>
											</div>
