			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Form </span> - Editar Alumnos</h4>
						...
						<div class="col-md-6">
							<fieldset>
								...
								<div class="form-group row">
									<label class="col-lg-3 col-form-label">Ingresa matrícula a buscar</label>
									<div class="col-lg-9">
										<div class="row">
											<div class="col-md-6">
								...
								<div class="text-right">
									<button type="submit" class="btn btn-primary">Buscar alumno <i class="icon-folder-search ml-2"></i></button>
								</div>
											...
											<div class="col-lg-9">
												<select data-placeholder="Cuatrimestres" class="form-control form-control-select2" data-fouc>
													...
													<optgroup label="Cuatrimestres">
														...
														<option value="3"Cuatrimestre >Cuatrimestre 3</option>
