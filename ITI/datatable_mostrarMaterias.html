			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Base de datos</span> - Materias</h4>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title"><b>MATERIAS</b></h5>
					...
					<div class="card-body">
						...
						<div class="table-responsive">
								<button type="submit" class="btn btn-outline-danger"  data-toggle="modal" data-target="#modal_form_horizontal">Agregar materia <i class="icon-file-plus ml-2"></i></button>
						</div>
					</div>
