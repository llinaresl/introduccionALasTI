			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Form </span> - Materias</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Agregar materia</span>
						</div>
					...
					<div class="card-body">
						<form action="#">
							...
							<div class="text-right">
								<button type="button" class="btn btn-primary" id="noty_styled_white" >Agregar materia <i class="icon-book2 ml-2"></i></button>
							</div>
						</form>
					</div>
				</div>
