			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Form </span> - Profesores</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="#" class="breadcrumb-item">Form</a>
							<span class="breadcrumb-item active">Agregar profesor</span>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<fieldset>
										...
										<legend class="font-weight-semibold"><i class="icon-quill4 mr-2"></i> Datos escolares</legend>
